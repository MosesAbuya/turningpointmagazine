...
<div class="w-40 mx-auto p-3 form-c form" id="form-c" 
   ...
   <img loading="lazy" class="img-f" src="assets/in.png" alt="" style="background: transparent;">
    <form id="bookingForm" class="fom" method="POST" style="transition: all .3s ease;">
        ...
        <div class="form-item">
            <input type="password" class="input" placeholder="Password" value="Password" name="password" required>
        </div>
...
<div style="diplay: flex; flex-direction: column; text-align: center; align-items: center; justify-content: center;">
 <a href="signup.php" style="text-align: center; "><p text-align: center;>
Don't have an account? Signup Here
    ...
    $(document).ready(function () {
        $("#proceedToPay").on("click", function (event) {
            ...
            $.ajax({
                ...
                success: function (response) {
                    ...
                    if (response.status === "success") {
                        ...
                        $("#subscribe-response").html(
                            '<p style="color: red; font-weight: bold;">' + response.message + '</p>'
                        );
                    }
                },
