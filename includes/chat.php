...
<h1>Multiple Whatsapp Chat Widget - By Dunia Blanter</h1>
<div class='credit'>Created by <a href='https://www.idblanter.com' target='_blank' title='Dunia Blanter'>Dunia
        Blanter</a></div>
...
<div id='whatsapp-chat' class='hide'>
    <div class='header-chat'>
        <div class='head-home'>
            <h3>Hello!</h3>
            <p>Click one of our representatives below to chat on WhatsApp or send us an email to rioblanter@gmail.com
            </p>
        </div>
    ...
    <div class='home-chat'>
        ...
        <a class='informasi' href='javascript:void(0);' title='Chat Whatsapp'>
            <div class='info-avatar'><img loading="lazy"
            ...
            </div><span class='my-number'>+254768579526</span>
        </a>
        <!-- Info Contact End -->
        <!-- Info Contact Start -->
        <a class='informasi' href='javascript:void(0);' title='Chat Whatsapp'>
        ...
        <!-- Info Contact End -->
        <div class='blanter-msg'>Call us to <b>+254768579526</b> from <i>0:00hs a 24:00hs</i></div>
    </div>
...
<a class='blantershow-chat' href='javascript:void(0);' title='Show Chat'><i class='fab fa-whatsapp'></i>How can I help
    you?</a>
...
$(document).on("click", "#send-it", function() {
    ...
    document.getElementById("get-number").innerHTML = $(this).children(".my-number").text(), $(
        ".start-chat,.get-new").addClass("show").removeClass("hide"), $(".home-chat,.head-home").addClass(
        "hide").removeClass("show"), document.getElementById("get-nama").innerHTML = $(this).children(
        ".info-chat").children(".chat-nama").text(), document.getElementById("get-label").innerHTML = $(
