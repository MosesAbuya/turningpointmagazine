...
$stmt = $pdo->prepare("SELECT * FROM orders WHERE user_id = ? ORDER BY date_created DESC LIMIT 1");
...
<div class="payment-container">
    ...
    <p><strong>Total Amount:</strong> Ksh <?php echo htmlspecialchars($total_amount); ?></p>
    ...
    <form id="payment-form">
        ...
        <!-- User enters only the M-Pesa number -->
        ...
        function checkPaymentStatus(invoice_id) {
            setInterval(function() {
                $.ajax({
                    ...
                    setTimeout(function () {
                        window.location.href = "profile.php#orders_area";
