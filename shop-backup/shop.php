...
$pdo = connect(); // Connect to database using PDO
...
<p style="text-align: center; color: blue;"><a style="color: blue; text-decoration: underline;" href="shop.php">View All Products</a></p>
